...
func (commonOpts *CommonOptions) InstallFlags(flags *pflag.FlagSet) {
	...
	flags.StringVarP(&commonOpts.Context, "context", "c", dockerContext, `context to use to connect to the daemon (overrides host flag, DOCKER_HOST env var and default context set with "docker context use")`)
}
