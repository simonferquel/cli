...
func (o *createOptions) process(s contextstore.Store) error {
	...
	helper, err := connhelper.GetConnectionHelper(o.dockerHost)
	if err != nil {
		return errors.Wrap(err, "unable to parse docker-host")
	}
	var helperEnabledHost string
	if helper != nil {
		helperEnabledHost = o.dockerHost
	} else {
	...
	if o.kubernetesKubeconfigFile != "" {
		if err = kubernetes.SetKubenetesContextKubeconfig(s, o.name, o.kubernetesKubeconfigFile, o.kubernetesKubeconfigContext, o.kubernetesDefaultNamespace, o.kubernetesKubeconfigEmbed); err != nil {
	...
	command.SetContextMetadata(&ctx, command.ContextMetadata{
		...
		HelperEnabledDockerHost: helperEnabledHost,
	})
